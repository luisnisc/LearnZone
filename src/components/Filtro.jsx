...
function Filtro({ex, Filter, b, setEx}) {
    const lista = b ?  "md:grid md:gap-4 md:grid-cols-5 md:grid-rows-3 md:ml-12 grid grid-cols-5 gap-4 mb-24 mt-20 mr-12 duration-500 "  : "flex flex-col mb-24 justify-center items-center duration-500";
...
function ExCard({ ex }) {
    ...
    const mostrar = a ? "truncate h-16" : "h-50";
