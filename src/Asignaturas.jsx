...
export default function Asignaturas() {
  ...
  const list = (anchor) => (
    <div
      className="w-48 h-full bg-gray-800 border-gray-200 "
    ...
    >
      ...
      <ul className="ml-2 text-white ">
        ...
        <button
          className="hover:text-blue-500"
          onClick={() => setFilter("LENGUAJE DE MARCAS")}
        >
          Lenguaje de Marcas
        </button>
        <button
  ...
  const lista = b
    ? "md:grid md:gap-4 md:grid-cols-5 md:grid-rows-3 md:ml-12 grid grid-cols-5 gap-4 mb-24 mt-20 mr-12 duration-500 w-full"
    : "flex flex-col mb-24 justify-center items-center duration-500";
